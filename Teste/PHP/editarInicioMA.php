...
<nav class="navbar navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <br><br><br>
   <main>       
   <h4 style="text-align:center">Editar destaques: escolher o genero do artista</h4>
        <div class="container">
    ...
    <hr/>
            ...
            if(!empty($_GET)){
                ...
                <form action="escolherArtistaDestaque.php" method="post" id="destaque">
                    <ul class="list-group list-group-horizontal">
               <?php foreach ($mus->listarGeneroByInicial($inicial) as $col) {?>
                <ul class="list-group list-group-horizontal">
                    <li class="list-group-item"><button class="btn btn-outline-dark" type="submit" value="<?php echo $col['nome'];?>" name="genero" ><?php echo $col['nome']?></li></button> 
                    </ul>
                <?php } ?>
             </form>
            <?php 
