...
<nav class="navbar navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <br><br><br>
   <main>       
   <h4 style="text-align:center">Editar destaques: escolher o artista da musica</h4>
        <div class="container">
        <div class="alert alert-success" role="alert">
            <h4 class="alert-heading"></h4>
                <p>Atualmente possuimos <?php echo count($mus->listarTodasAutorias()) . " ";?> artistas no total</p>
            </div>
            <div class="container">
                <div class ="row">
                    <div class="col">
    ...
    <hr/>
            ...
            if(!empty($_GET)){
                ...
                <form action="escolherMusicaDestaque.php" method="post" id="destaque">
                    <ul class="list-group list-group-horizontal">
               <?php foreach ($mus->listarAutoriasByInicial($inicial) as $col) {?>
                <ul class="list-group list-group-horizontal">
                    <li class="list-group-item"><button class="btn btn-outline-dark" type="submit" value="<?php echo $col['nome_autoria'];?>" name="autoria" ><?php echo $col['nome_autoria']?></li></button> 
                    </ul>
                <?php } ?>
             </form>
            <?php 
