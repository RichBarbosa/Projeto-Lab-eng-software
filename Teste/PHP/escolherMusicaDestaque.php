    ...
    <div class="container">
        <div class="alert alert-success" role="alert">
            <h4 class="alert-heading"></h4>
              <p>Atualmente possuimos <?php echo count($cat->getMusica($autoria)) . " ";?> músicas do Artista <b><?php echo $autoria;?></b></p>
        </div>
      </div>
  <hr/>       
    <div class="container">
      <div class="row">
          <?php foreach($cat->getMusica($autoria) as $col){ ?> 
            <div class="col-sm-1">
              <form action="../editar_DestaqueM.php" method="post">
                <input type="hidden" name="autoria" value="<?php echo $autoria;?>">
                <input type="hidden" name="idM" value="<?php echo $col['id'];?>">
                <button type="submit " name="musica" value="<?php echo $col['nome_musica']; ?>" class="btn btn-outline-dark"><?php echo $col['nome_musica'];?></button>
              </Form>                          
              <hr>
            </div>
          <?php }?> 
