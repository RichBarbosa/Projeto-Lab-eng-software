...
<div class="btn-group" role="group" aria-label="Basic example">
   ...
   <div style="text-align:end;" class= "col-sm-10">
            ...
            <form action="Tag_jogo_gif.php" method="get">
              ...
              <div class= "col-sm-4">
                <?php
                  ...
                  if($dono != null){?>
                    <form method="get" action="gifUserJ.php">
        ...
        <?php if (!empty($_SESSION['nome'])) {?>        
          <h6>dê uma avaliação</h6>
            <form action="avaliar.php" method="post">
              ...
              ?>
              <input type="hidden" name="tipo" value="gifJ">
              ...
              <form action="favoritar_gifJ.php" method="post">
                ...
                <?php } ?>
                       ...
                       <form action="curtir.php" method="post">
                        <li><br><button class="btn btn-success" type ="submit" name="descurtirGJ" value="<?php echo $idImagem;?>" >curtido!</button></li>
                        </form> 
              <?php }else{ ?>
                          <form action="curtir.php" method="post">
                              <li><br><button class="btn btn-outline-success" type ="submit"
                              name="curtirGJ" value="<?php echo $idImagem;?>"
                              <?php if (empty($_SESSION['nome'])){?> 
    ...
    <div class="row">
    <div class="col-6">
      <form class="d-flex" action="comentariosJG.php" method="post">
        <input type="hidden" name="idimagem" value="<?php echo$idImagem;?>">
       <?php if($id == null){ ?>
