...
<body>
   ...
   <main class="form-signin">
    <form action="enviar_chave.php" method="POST">
      <h1 class="h3 mb-3 fw-normal">Informe seu email para redefinir sua senha, se for o correto, você
          será redirecinado para redefinir sua senha.
      </h1>
        <div class="form-floating">
        <input type="email" class="form-control" id="floatingPassword"  name="email" required autocomplete="off">
        <label for="floatingPassword">Email</label>
      </div>
      <button class="w-100 btn btn-lg btn-secondary" type="submit">validar email</button>
      <div class="form-floating">
      </div>
    </form>
