...
<nav class="navbar navbar-dark bg-dark">
  <div class="container-fluid">
   ...
   <main>
       <h1 id="Topo">Upload: NSFW</h1>
       <div class="container">
          <div style="text-align: center;"> 
          <p>escolha o que deseja submeter, escreva pelo menos uma tag, e selecione a sub categoria.</p>
    ...
    <hr>
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <form action="uploadNSFW.php" method="POST" enctype="multipart/form-data">
                        <div class="row mb-3">
                        ...
                        <fieldset class="row mb-3">
                            <div class="col-sm-10">
                                <div class="form-check">
                                    <div>
                                        <h4>Selecione uma item</h4>
                                        <input class="form-control form-control-lg"  id="upload" type="file" accept=".png, .jpg, .jpeg, .gif" name = "arquivo" required>
                                    </div>       
                                </div>
                        </div>
                        </fieldset>
                        <div class="row mb-3">
                            <div class="col-sm-10 offset-sm-2">
                                <div class="form-check">
                                    <h4>Selecione a categoria do item </h4>
                                    <select class="form-select" aria-label="Default select example" name= "categoria">
                                        <?php foreach($NSFW->listarCategorias() as $col){ ?>      
