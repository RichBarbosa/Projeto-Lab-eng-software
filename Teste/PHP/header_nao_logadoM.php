...
<head>
          ...
          <nav class="navbar navbar-dark bg-dark">
                ...
                <nav class="navbar navbar-dark bg-dark">
                    ...
                    <form class="d-flex" action="pesquisaMusica.php" method="GET">
                            <input class="form-control " type="Pesquisar" placeholder="Pesquisar Músicas" aria-label="Search"  name="buscar" autocomplete="off">
  ...
  <div class="bg-dark p-4">
    ...
    <li class="nav-item">
            ...
            <li class="nav-item">
            <a class="nav-link" href="novo_artista.php"><button class="btn btn-secondary"><img src="https://img.icons8.com/office/16/000000/upload--v1.png"/>adicionar um artista</button></a>
            </li>
        </ul>
  </div>
</div>
