...
<nav class="navbar navbar-dark bg-dark">
  <div class="container-fluid">
   ...
   <main>
       <h1 id="Topo">Upload Gif: anime</h1>
       <div class="container">
          <div style="text-align: center;"> 
          <p>escolha o Gif que deseja submeter, escreva pelo menos uma tag, e selecione a sub categoria do gif.</p>
    ...
    <hr>
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <form action="uploadGif.php" method="POST" enctype="multipart/form-data">
                        <div class="row mb-3">
