...
<head>
   ...
   <header id="top" >          
          <nav class="navbar navbar-dark bg-dark">
                ...
                <nav class="navbar navbar-dark bg-dark">
                    <div class="container-fluid">
                        <form class="d-flex" action="pesquisaNSFW.php" method="GET">
  ...
  <div class="bg-dark p-4">
    <ul class="nav navbar-dark bg-dark">
    <li class="nav-item">
                <a class="nav-link" href="buscar_NSFW.php"><button class="btn btn-secondary" type="button">buscar</button></a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="upload_NSFW.php"><button class="btn btn-secondary"><img src="https://img.icons8.com/office/16/000000/upload--v1.png"/>Submeter conteúdo</button></a>
            </li>
        </ul>
  </div>
</div>
