...
<head>
   ...
   <header id="top" >          
          <nav class="navbar navbar-dark bg-dark">
                ...
                <nav class="navbar navbar-dark bg-dark">
                    <div class="container-fluid">
                    <form class="d-flex" action="PHP\pesquisaJogo.php" method="GET">
  ...
  <div class="bg-dark p-4">
    <ul class="nav navbar-dark bg-dark">
            ...
            <li class="nav-item">
                <a class="nav-link" href="PHP\buscar_por_categoria_jogo_gif.php"><button class="btn btn-secondary" type="button">Buscar por gifs</button></a>
            </li>
            <li class="nav-item">
