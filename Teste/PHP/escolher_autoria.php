   ...
   <h4 style="text-align:center">Buscar</h4>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col align-self-center">
                    <form action="escolher_autoria.php" method="GET">
    ...
    <hr/>
            ...
            if(!empty($_GET['inicial'])){
                ...
                <form action="Subimicao_musica.php" method="GET">
                    <ul class="list-group list-group-horizontal">
               <?php foreach ($mus->listarAutoriasByInicial($inicial) as $col) {?>
                <ul class="list-group list-group-horizontal">
                    <li class="list-group-item"><button class="btn btn-outline-dark" type="submit" value="<?php echo $col['nome_autoria'];?>" name="escolha" ><?php echo $col['nome_autoria']?></li></button> 
                    </ul>
                <?php } ?>
             </form>
            <?php 
