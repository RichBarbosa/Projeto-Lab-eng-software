...
<body>
   ...
   <main>       
    <h2>Gerenciar GIfs<h2>
        <form action="atualizar_gifJogo.php" method="post" >
            <input type="hidden" name="id" value="<?php echo $idImagem;?>">
            <div class="container">
              <div class=row>
                <div class="col-6">
              <div class="imgT">
              <img src="<?php echo $cat->getCaminhoJogo($idImagem);?>" class="img-thumbnail" alt="...">
                </div>
              </div>
     <div class="col-6">         
    <table class="table">
      ...
      <tr>
        <td><input type="text" name="tag1" value="<?php echo $cat->getJogoTag1($idImagem);?>" required autocomplete="off"></td>
      </tr>
      <tr>
        <th>Tag2</th>
      </tr>
      <tr>
        <td><input type="text" name="tag2" value="<?php echo $cat->getJogoTag2($idImagem);?>" autocomplete="off"></td>
      </tr>
      <tr>
        <th>Tag3</th>
      </tr>
      <tr>
        <td><input type="text" name="tag3" value="<?php echo $cat->getJogoTag3($idImagem);?>" autocomplete="off"></td>
      </tr>
      <tr>
        <th>Tag4</th>
      </tr>
      <tr>
        <td><input type="text" name="tag4" value="<?php echo $cat->getJogoTag4($idImagem);?>" autocomplete="off"></td>
      </tr>
      <tr>
        <th>Tag 5</th>
      </tr>
      <tr>
        <td><input type="text" name="tag5" value="<?php echo $cat->getJogoTag5($idImagem);?>"autocomplete="off"></td>
      </tr>
      <tr>
      ...
      <td>
        ...
        data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">Mover imagem</button></td>
        </tr>
      </td>
      <tr>
  ...
  <div class="form-check">
    <h6>mover para:</h6>
        <form action="mover.php" method="POST">
          <input type="hidden" name="idJGif" value="<?php echo $idImagem;?>">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form action="excluir_gifJogo.php" method="post">
