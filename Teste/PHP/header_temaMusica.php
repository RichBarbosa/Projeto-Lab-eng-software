...
<head>
   ...
   <header id="top" >          
          <nav class="navbar navbar-dark bg-dark">
                ...
                <nav class="navbar navbar-dark bg-dark">
                    <div class="container-fluid">
                        <form class="d-flex" action="pesquisaMusica.php" method="GET">
                            <input class="form-control " type="search" placeholder="Pesquisar Músicas" aria-label="Search" name="buscar" autocomplete="off">
  ...
  <div class="bg-dark p-4">
    <ul class="nav navbar-dark bg-dark">
            <li class="nav-item">
                <a class="nav-link" href="buscar_genero_musica.php"><button class="btn btn-secondary" type="button">Generos</button></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="buscar_autoria_musica.php"><button class="btn btn-secondary" type="button">Artistas</button></a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="escolher_autoria.php"><button class="btn btn-secondary"><img src="https://img.icons8.com/office/16/000000/upload--v1.png"/>adicionar uma letra</button></a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="escolher_genero.php"><button class="btn btn-secondary"><img src="https://img.icons8.com/office/16/000000/upload--v1.png"/>adicionar um artista</button></a>
            </li>
        </ul>
  </div>
</div>
