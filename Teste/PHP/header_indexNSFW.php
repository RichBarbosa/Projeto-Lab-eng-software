...
<head>
   ...
   <header id="top" >          
          <nav class="navbar navbar-dark bg-dark">
                    ...
                    <div class="d-grid gap-2 d-md-block">
                        ...
                        <div class="btn-group dropstart">
                            ...
                            <li><a class="dropdown-item" href="index.php">Inicio</a></li>
                                ...
                                <li><a class="dropdown-item" href="PHP\favoritosNSFW.php">Favoritos(NSFW)</a></li>                                 
                ...
                <nav class="navbar navbar-dark bg-dark">
                    <div class="container-fluid">
                    <form class="d-flex" action="PHP\pesquisaNSFW.php" method="GET">
  ...
  <div class="bg-dark p-4">
    <ul class="nav navbar-dark bg-dark">
    <li class="nav-item">
                <a class="nav-link" href="PHP\buscar_NSFW.php"><button class="btn btn-secondary" type="button">buscar</button></a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="PHP\upload_NSFW.php"><button class="btn btn-secondary"><img src="https://img.icons8.com/office/16/000000/upload--v1.png"/>Submeter conteúdo</button></a>
            </li>
        </ul>
  </div>
</div>
