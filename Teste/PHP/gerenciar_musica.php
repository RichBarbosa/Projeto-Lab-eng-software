          ...
          <h6>Musicas</h6>
            ...
            <?php
              if(!empty($_POST)){
                ...
                foreach($cat->getMusica($escolha) as $col){ ?>
                    <ul class="list-group list-group-horizontal">
                    <li ><button type="submit "value= "<?php echo $col['id'] ?>" class="btn btn-secondary" name= "musica"><?php echo $col['nome_musica'] ?></button></li>                       
                    </ul>
                    </div>
            <?php }
                }else{
