...
<nav class="navbar navbar-dark bg-dark">
  <div class="container-fluid">
   ...
   <main>
       <h1 id="Topo">Upload música: <?php echo $mus->getAutoriaByAutoria($autoria);?></h1>
       <div class="container">
          <div style="text-align: center;"> 
            <p>Digite o nome, e a letra da música. Você também pode informar a tradução e links
              para onde é possivel ouvi-la.
            </p> 
            <div class="aviso">
      ...
      <div class="container">
        <div class="row">
          <div style="text-align:center">
            <button type="submit" class="btn btn-outline-success" form="musica">Enviar</button>
          </div>
        </div>                         
      </div>
    <hr>
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <form action="upload_musica.php" method="POST" id="musica">
                      <input type="hidden" name="autoria" value="<?php echo $mus->getGeneroByAutoria($autoria);?>">
                        <div class="row mb-3">
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputText" name="nome" placeholder="Nome da música" required autocomplete="off">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputText" name="streaming" placeholder="Link em um aplicativo de streaming (opcional)" autocomplete="off">
                            </div>
                        </div>
                        <div class="row mb-3">
                        <h6>letra da música </h6>
                          <textarea class="form-control" name="letraO" id="com" cols="50" rows="70" required></textarea>
                        </div>
                        <div class="row mb-3">
