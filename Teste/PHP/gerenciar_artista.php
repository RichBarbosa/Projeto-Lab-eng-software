  ...
  <div class="container-fluid">
   ...
   <main>       
       <div class="container">
            <div class="row">
                <div class="col sm-6">
                    <div class="form-check">
                        <h6>Excluir artista</h6>
                        <form action="deletar_artista.php" method="POST" id="deletar">
                          ...
                          <br><br>
                        <h6>renomear artista</h6>
                        <form action="renomear_artista.php" method="POST" id="renomearA">
                            <select class="form-select" aria-label="Default select example" name= "categoria">
                                <?php foreach($cat->listarTodasAutorias() as $col){ ?>      
                                    <option value="<?php echo $col['nome_autoria'];?>"><?php echo $col['nome_autoria'];?></option>
                                <?php }?>
                        ...
                        <br>
                        <br><h6>Mover artista</h6>
                        <form action="mover.php" method="POST" id="mover">
                        ...
                        <div class="collapse" id="collapseExample2">
                          <div class="card card-body">
                            <h6>para:</h6>
                            <select class="form-select" aria-label="Default select example" name= "categoria" form="mover">
                              <?php foreach($cat->listarGenero() as $col){ ?>      
                              <option value="<?php echo $col['id'];?>"><?php echo $col['nome'];?></option>
                              <?php }?>
                            </select>
                            <button type="submit " class="btn btn-secondary" form="mover">Confirmar</button>
                          </div>
                        </div> 
                      </div>                                               
                </div>
        ...
        <div class="col-sm-6">
          <br><br>
          <h6>Lista de artistas registrados</h6>
    ...
    <?php foreach($cat->listarTodasAutorias() as $col){ ?>
        <tr>
            <td><?php echo $col['nome_autoria'];?></td>
            <?php }?> 
        </tr>
    </Table>
    </div>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
  <div class="offcanvas-header">
    <h5 id="offcanvasTopLabel">Excluir artista</h5>
    <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
  </div>
  <div class="offcanvas-body">
    Alerta, excluir um artista irá apagar todas suas respectiva letras músicais registradas, deseja continuar?
