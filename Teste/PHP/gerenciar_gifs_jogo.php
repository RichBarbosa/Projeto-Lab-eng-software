...
<body>
                    ...
                    <div class="d-grid gap-2 d-md-block">
                        <div class="btn-group dropstart">
                            ...
                            <li><a class="dropdown-item" href="../index.php">Inicio</a></li>
                                ...
                                <li><a class="dropdown-item" href="gerenciar_imagens.php">Gerenciar imagens</a></li>
                                <li><a class="dropdown-item" href="gerenciar_gifs.php">Gerenciar Gifs</a></li>

                                <?php }?>
                                <li><a class="dropdown-item" href="favoritos.php">Favoritos</a></li>                                
                                <li><a class="dropdown-item" href="perfil.php">Perfil de usuários</a></li>
  ...
  <h2>Gerenciar gifs<h2>
       <div class="container">
        ...
        <div class="col-sm-6">
            <form action="gifJogo.php" method="post">
          <h6>Lista de gifs </h6>
                <div id= "div1">         
            <?php
              if(!empty($_POST)){
                $escolha = $_POST['categoria']; 
                foreach($cat->listarGifJogo($escolha) as $col){ ?>
