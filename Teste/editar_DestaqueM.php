...
<nav class="navbar navbar-dark bg-dark">
  <div class="container-fluid">
   ...
   <main>
       ...
       <p>você escolheu a música <b><?php echo $musica;?></b> do artista <b><?php echo $autoria;?></b> para destacar no inicio,   
           escolha a posição do destaque</p>
        <div class="container">
              <div class=row>
                <div class="col-6">
              <div class="imgT">
              <form action="PHP\editarDestaquesM.php" method="post">
...
<?php
    ...
    header('Location: PHP\editarInicioM.php');
}
}else{ 
