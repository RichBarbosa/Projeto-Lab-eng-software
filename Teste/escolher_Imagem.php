...
<body>
   ...
   <div class="container">
            <div class="row">
                <div class="col-4">
                    <h6>Gerenciar imagens de anime</h6>
                    <a class="nav-link" href="PHP/gerenciar_imagens.php"><button class="btn btn-secondary">Gerenciar</button></a>
                </div>
                <div class="col-4">
                    <h6>Gerenciar imagens de jogos</h6>
                    <a class="nav-link" href="PHP/gerenciar_imagens_Jogo.php"><button class="btn btn-secondary">Gerenciar</button></a>
