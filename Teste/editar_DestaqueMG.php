...
<nav class="navbar navbar-dark bg-dark">
  <div class="container-fluid">
   ...
   <main>
       ...
       <p>você escolheu o genero <b><?php echo $genero;?></b> para destacar no inicio,   
           escolha a posição do destaque</p>
        <div class="container">
              <div class=row>
                <div class="col-6">
              <div class="imgT">
              <form action="PHP\editarDestaquesMG.php" method="post">
...
<?php
    ...
    header('Location: PHP\editarInicioMG.php');
}
}else{ 
