...
include('PHP\classes\Musica.php');
...
<nav class="navbar navbar-dark bg-dark">
  <div class="container-fluid">
   ...
   <main>
       ...
       <p>você escolheu o artista <b><?php echo $autoria;?></b> do genero <b><?php echo $genero;?></b> para destacar no inicio,   
           escolha a posição do destaque</p>
        <div class="container">
              <div class=row>
                <div class="col-6">
              <div class="imgT">
              <form action="PHP\editarDestaquesMA.php" method="post">
            ...
            <option value="destaque6">sexto destaque</option>
                ...
                <a href="PHP\editarInicioMA.php" class="btn btn-success">Cancelar</a>
            </form>    
                </div>
              </div>
        </div>       
...
<?php
    ...
    header('Location: PHP\editarInicioMA.php');
}
}else{ 
