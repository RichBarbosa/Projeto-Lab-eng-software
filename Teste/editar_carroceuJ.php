   ...
   <main>
       ...
       <p>você selecionou a seguinte imagem para editar o carrossel, escolha a posição da imagem</p>
        <div class="container">
              <div class=row>
                <div class="col-6">
              <img src=" PHP\<?php echo $cat->getCaminhoJogo($idImagem);?>" class="img-thumbnail" alt="...">
              <form action="PHP\editarCarroceuJ.php" method="post">
            <input type="hidden" name="imagem" value="<?php echo $idImagem;?>">
             <select class="form-select" aria-label="Default select example" name="escolha" id="">
                ...
                <a href="PHP\editar_inicioJ.php" class="btn btn-success">Cancelar</a>
            </form>    
              </div>
        </div>
        <br>
